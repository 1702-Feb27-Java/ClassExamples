...
public class ConnectionClass {
	...
	private ConnectionClass() {
		...
		try {
			...
			InputStream inputStream = ConnectionClass.class.getClassLoader()
					.getResourceAsStream("TuitionDBProp.properties");
	...
	private Connection createConnection() {
		...
		try {
			...
			conn = DriverManager.getConnection(url, uname, pw); // Assign a
																// connection
