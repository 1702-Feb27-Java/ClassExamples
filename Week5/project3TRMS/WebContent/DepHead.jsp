...
<body>
	<form class="form-horizontal">
		<fieldset>
			<!-- Form Name -->
			<legend>Welcome to the department head page.</legend>
			...
			<!-- Button -->
			<div class="form-group">
				<label class="col-md-4 control-label" for="viewappstatis" formaction="appApproval.jsp"  value="/appApproval.jsp">View
