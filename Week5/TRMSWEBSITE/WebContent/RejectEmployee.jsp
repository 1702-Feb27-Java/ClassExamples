...
<body>
	<nav class="navbar navbar-light bg-faded">
			...
			<form class="form-horizontal" action="RejectEmps" method = "POST">
<fieldset>

<!-- Form Name -->
<legend>Reject Application</legend>

<!-- Textarea -->
<div class="form-group" >
  <label class="col-md-4 control-label" for="rejectionmessage">Rejection Message</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="rejectionmessage" name="rejectionmessage" placeholder="ENTER A REASON..."></textarea>
  </div>
</div>
