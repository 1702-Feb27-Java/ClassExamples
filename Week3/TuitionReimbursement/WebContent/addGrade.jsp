...
<html>
	...
	<body>
		...
		<div class="row text-center">
			...
			<div class="col-md-4">
				<form action="SubmitGrade.do" method="POST" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    <label for="time">Grade Achieved</label>
				    <input type="text" required class="form-control" id="finalGrade" placeholder="Final Grade" name="finalGrade">
				  </div>
