...
<title>Reimbursement Success</title>
</head>
<body>
	...
	<div class="row text-center">
        ...
        <p style="font-size:20px;color:#5C5C5C;">Operation Successfully Applied</p>
        <a href="LoginServlet" class="btn btn-success">Back to Menu</a>
    	<br><br>
        </div>
