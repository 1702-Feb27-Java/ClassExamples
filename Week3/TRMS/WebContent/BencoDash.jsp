...
<body style="background-color:orange">
	<h1 align="center" style="color:blue">Welcome to the Benco Dashboard!</h1><hr><br>
	...
	<form align="center" action="BencoPendingServlet.do" style="color:blue" method="POST">
		<input type="submit" value="View Reimbursements Pending Benco Approval">
	</form>
