...
<style>
	...
	th {text-align:center; background-color:#002266; color:white;}
	td {text-align:center;}
	.button {text-align:center;background-color:#002266; 
	...
	<div align="center">
		<form = action="DeleteEvent" method="POST">
			...
			<table width=100%>
				...
				<tr><td><input name="EventType" style="width:300px; border:none" value="<%=eventList.get(eventid).getEventType()%>"></td>
					<td><input name="Priority" value="<%=eventList.get(eventid).getPriority()%>"></td>
				...
				<tr><td><input type="text" name="Start" value="<%=eventList.get(eventid).getStartDate()%>"></td>
					...
					<td><input name="Grade" style="width:300px; border:none" value="<%=eventList.get(eventid).getGradeFormat()%>"></td></tr>
			</table>
			<table width=100%>
			<tr><th>DESCRIPTION:</th></tr>
				...
				<tr><td><input name="justify" size=170% style="border:none; align:left; text-align:left" value="<%=eventList.get(eventid).getJustify()%>"></td></tr>
			</table>
			<table width=100%>
