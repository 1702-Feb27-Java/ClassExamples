...
<%	user = (Employee)session.getAttribute("user"); reimbursements = ReimbursementServiceImpl.getReimbursementService().getReimbursementsOf(user); %>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="container" id="content">
	    ...
	    <div class="table-responsive">
		    ...
		    <% for (Reimbursement reimbursement : reimbursements) { %>
			    <tr class="clickable-table-row" title="View Reimbursement #<%= reimbursement.getId() %>" data-href="app?id=<%= reimbursement.getId() %>">
