	...
	<div class="container">
		<form action="NewReimbursement" method="POST">
			<div class="form-group">
				<label>Description</label> <input type="text" name="reimburse-desc"
					id="reimburse-desc" class="form-control" />
			</div>

			<div class="form-group">
				<label>Location</label> <input type="text" name="reimburse-loc"
					id="reimburse-loc" class="form-control" />
			</div>
			<div
				class="${callback-cost-missing != null ? 'form-group has-error' : 'form-group'}">
				<label>Cost Of Event</label> <input type="number"
					name="reimburse-cost" id="reimburse-cost"
					oninput="updateReimbursementField()" class="form-control" />
			</div>
			<div class="row">
			...
			<div class="form-group col-sm-6">
				<label>Grade Format</label><select id="reimburse-grade-format"
					name="reimburse-grade-format" onchange="showCustomGradingFormat()">
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					<label>End Date</label> <input type="date"
						name="reimburse-date-end" id="reimburse-date-end"
						class="form-control" />
				</div>
			</div>
			<div class="form-group">
				<label>Predicted Reimbursement</label> <input class="form-control"
					data-max-amount="${maxReimbursement}" type="number"
					name="reimburse-reimbursement" id="reimburse-reimbursement"
					readonly />
			</div>
