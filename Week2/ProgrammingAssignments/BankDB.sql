...
CREATE OR REPLACE PROCEDURE update_status(uid IN NUMBER, status IN NUMBER)
IS 
BEGIN
    UPDATE ACCOUNTS
    SET STATUSID = status
...
CREATE OR REPLACE 
SELECT u.USERID, u.FIRSTNAME, u.LASTNAME, u.USERNAME, u.PW, u.ROLEID, a.STATUSID, a.TYPEID, a.BALANCE 
FROM USERS u 
INNER JOIN CUSTOMERACCOUNTS ca ON u.USERID=ca.USERID 
INNER JOIN ACCOUNTS a ON ca.ACCTID=a.ACCTID WHERE TYPEID=1;
