...
public class LogInClass {
	...
	// we need this hashtable for username and password key-value pairs
	static Hashtable<String, String> hashC = new Hashtable<String, String>();

	public static void customerLogIn() {
		
		// store all usernames and pws to a hashtable
	...
	public static void employeeLogIn() {
		// get all usernames and pws into a hashtable
		hashC = daoUser.getUsernamePW();
	...
	public static void adminLogIn() {
		...
		// stores all usernames and pws into a hashtable
		hashC = daoUser.getUsernamePW();
